...
const extractData = pathImage => {
  return new Promise((resolve, reject) => {
    ...
    var xml = fs.readFileSync('./modules/canCuoc/training.xml', 'utf8')
    ...
    fields.forEach((field, i) => {
      ...
      cv.imwrite(`./images/temp/canCuoc${ i }.jpg`, roiMatrix)
      const promise = extractText(`./images/temp/canCuoc${ i }.jpg`).then(
        function(result) {
